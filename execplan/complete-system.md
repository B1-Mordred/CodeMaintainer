...
Current pause: implementation work is stopped after the 31.5 performance/soak coverage checkpoint. `I2-31.5` remains in progress, and `I2-DOD-26` documented Compose stack and runnable acceptance is the next safe implementation boundary when work resumes.
