...
- [ ] (2026-07-20 22:00Z) Increment 2 Milestone 1 in progress: additive typed configuration registry, seven-scope resolver, scoped revisions, drafts/checks/review/apply/rollback, immutable snapshots, ETag-bound REST/OpenAPI/CLI, and redacted import/export are implemented through migration 17. The dedicated browser workbench, complete prerequisite handlers, setting-level coverage inventory, and automatic job-acceptance snapshot integration remain open.
