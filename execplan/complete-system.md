...
Increment 2 Milestone 6 has started but remains open. The scheduler now has safe defaults, deterministic simulation, retained decision evidence, API/CLI/browser parity, and transactional live lease enforcement for fairness and declared CPU/RAM co-residence. Richer resource/provider inputs and recommendation/benchmark surfaces remain before the scheduler milestone can close.
