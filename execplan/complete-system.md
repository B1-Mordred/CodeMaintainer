...
- [ ] (2026-07-20 22:25Z) Increment 2 Milestone 1 in progress: additive typed configuration registry, seven-scope resolver, scoped revisions, drafts/checks/review/apply/rollback, immutable accepted-job snapshots, ETag-bound REST/OpenAPI/CLI, redacted import/export, the dedicated accessible browser workbench, and a 13-setting coverage gate are implemented through migration 17. Generic dependency evaluation, real prerequisite handlers, and the deferred real-browser focus/overflow pass remain open.
