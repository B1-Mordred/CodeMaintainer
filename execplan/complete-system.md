...
Current pause: implementation work is stopped after the 31.4 local-fake E2E coverage checkpoint. `I2-31.4` remains in progress, and `I2-31.5` performance and bounded soak criteria is the next safe implementation boundary when work resumes.
