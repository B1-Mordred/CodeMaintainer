...
- [ ] Milestone 5 memory and scheduling (completed through 2026-07-20 19:05Z: migration-backed project memory with strict registered-repository namespaces; provenance, secret scanning, quarantine, verified/human/merged promotion bases, optimistic corrections and lifecycle changes, content-clearing tombstones, append-only history and retrieval traces; 4K-token bounded project-before-ranking API retrieval; reviewer/administrator RBAC; generated OpenAPI client; and cross-project/quarantine tests. Remaining: OpenViking adapter/profile, export/restore/reindex, workflow extraction, authenticated merge-event promotion, Hermes tools, schedules, and reviewed skill proposals).
