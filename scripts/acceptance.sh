...
mkdir -p .data .cache/go/build .cache/go/mod .cache/npm
...
compose -f compose.yaml -f compose.dev.yaml build controller maintainctl
compose -f compose.yaml -f compose.dev.yaml up -d controller
