...
//go:embed migrations/013_github_events.sql
var migration013 string

//go:embed migrations/014_rebuild_memory_index_queue.sql
var migration014 string

//go:embed migrations/015_notifications.sql
...
//go:embed migrations/018_intelligence.sql
var migration018 string

//go:embed migrations/019_intelligence_workflow.sql
var migration019 string

//go:embed migrations/020_intelligence_reviews.sql
var migration020 string

//go:embed migrations/021_capabilities_onboarding.sql
var migration021 string

//go:embed migrations/022_forges.sql
var migration022 string

//go:embed migrations/023_windows_workers.sql
var migration023 string

//go:embed migrations/024_forge_webhook_events.sql
var migration024 string

//go:embed migrations/025_task_contracts_risk.sql
var migration025 string

//go:embed migrations/026_agent_contract_validations.sql
var migration026 string

//go:embed migrations/027_test_designer_reports.sql
var migration027 string

//go:embed migrations/028_golden_rehearsals.sql
var migration028 string

//go:embed migrations/029_documentation_manifests.sql
var migration029 string

//go:embed migrations/030_policy_lifecycle.sql
var migration030 string

//go:embed migrations/031_policy_test_runs.sql
var migration031 string

//go:embed migrations/032_test_designer_dispositions.sql
var migration032 string

//go:embed migrations/033_golden_comparison_profiles.sql
...
//go:embed migrations/036_provider_capability_probes.sql
...
//go:embed migrations/039_evaluation_lab.sql
var migration039 string

//go:embed migrations/040_observability_support.sql
...
func allMigrations() []migrationStep {
	return []migrationStep{
		{1, migration001}, {2, migration002}, {3, migration003}, {4, migration004}, {5, migration005},
		{6, migration006}, {7, migration007}, {8, migration008}, {9, migration009}, {10, migration010},
		{11, migration011}, {12, migration012}, {13, migration013}, {14, migration014}, {15, migration015},
		{16, migration016}, {17, migration017}, {18, migration018}, {19, migration019}, {20, migration020},
		{21, migration021}, {22, migration022}, {23, migration023}, {24, migration024}, {25, migration025},
		{26, migration026}, {27, migration027}, {28, migration028}, {29, migration029}, {30, migration030},
		{31, migration031}, {32, migration032}, {33, migration033}, {34, migration034}, {35, migration035},
		{36, migration036}, {37, migration037}, {38, migration038}, {39, migration039}, {40, migration040},
	}
}
