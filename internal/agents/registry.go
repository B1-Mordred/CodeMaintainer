...
func BuiltInContracts() []ContractDescriptor {
	contracts := []ContractDescriptor{
		descriptor(ContractTaskPacket, "Agent task packet", taskPacketSchema, []string{"implementation", "repair", "test_designer", "documentation", "qc"}, []string{"json_schema", "json_object"}),
...
const documentationManifestSchema = `{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":false,"required":["job_id","schema_version","project_id","contract_sha256","risk_level","result_sha","source_context","policy_version","requirements","changes","checks","unsupported_claims","edits","status","policy_summary"],"properties":{"id":{"type":"string"},"job_id":{"type":"string"},"schema_version":{"const":1},"project_id":{"type":"string"},"contract_sha256":{"type":"string","pattern":"^[a-f0-9]{64}$"},"risk_level":{"enum":["low","medium","high"]},"result_sha":{"type":"string"},"source_context":{"type":"string"},"policy_version":{"type":"string"},"requirements":{"type":"array","maxItems":200},"changes":{"type":"array","maxItems":200},"checks":{"type":"array","maxItems":200},"unsupported_claims":{"type":"array","maxItems":200},"edits":{"type":"array","maxItems":64},"status":{"enum":["passed","changes_applied","no_documentation_required","blocked"]},"policy_summary":{"type":"string"},"created_at":{"type":"string","format":"date-time"}}}`
