...
const taskPacketSchema = `{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":false,"required":["schema_version","mode","job_id","original_task","acceptance_criteria","base_sha","review_cycle","relevant_files","verification"],"properties":{"schema_version":{"const":1},"mode":{"enum":["implementation","repair","qc"]},"job_id":{"type":"string","pattern":"^[A-Za-z0-9][A-Za-z0-9._-]{0,127}$"},"original_task":{"type":"string","minLength":1,"maxLength":131072},"acceptance_criteria":{"type":"array","minItems":1,"maxItems":64},"base_sha":{"type":"string","pattern":"^[a-f0-9]{40}([a-f0-9]{24})?$"},"result_sha":{"type":"string"},"review_cycle":{"type":"integer","minimum":0,"maximum":10},"diff":{"type":"string","maxLength":1048576},"relevant_files":{"type":"array","maxItems":64},"verification":{"type":"array","maxItems":64},"blocking_findings":{"type":"array","maxItems":100}}}`
...
const testProposalSchema = `{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":false,"required":["schema_version","job_id","contract_sha256","risk_level","proposals","dispositions_required"],"properties":{"schema_version":{"const":1},"job_id":{"type":"string"},"contract_sha256":{"type":"string","pattern":"^[a-f0-9]{64}$"},"risk_level":{"enum":["medium","high"]},"proposals":{"type":"array","maxItems":100,"items":{"type":"object","required":["id","claim","evidence_ids"],"properties":{"id":{"type":"string"},"claim":{"type":"string"},"evidence_ids":{"type":"array","items":{"type":"string"}}}}},"dispositions_required":{"type":"boolean"}}}`
